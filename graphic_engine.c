...
void graphic_engine_paint_game(Graphic_engine *ge, Game *game){
  ...
  sprintf(str, " next or n, back or b, left or l, right or r, roll or rll, pickup or p, drop or d, exit or e, move or m , inspect or i, turnon or ton, turnoff or toff, open <lnk> with <obj> or op <lnk> with <obj>");
  screen_area_puts(ge->help, str);
